...
We're building tools to collapse the distance between an idea and working silicon. The goal is
...
<Callout tone="success">
  ...
  our pipeline, email [aditya@microalchemy.xyz](mailto:aditya@microalchemy.xyz).
</Callout>
